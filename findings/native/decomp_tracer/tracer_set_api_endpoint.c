...
void sym.tracer_set_api_endpoint(int64_t arg1)
{
...
code_r0x0004ff74:
        ...
        *(undefined *)(uVar5 + uVar2) = 0;
        (**(code **)(iVar3 + 0x50))(piVar4, &var_70h);
        if ((var_70h & 1U) != 0) {
            fcn.000b3554(var_60h);
        }
        iVar3 = var_58h;
        if ((char)var_50h != '\0') goto code_r0x0004ffb8;
    }
    if (*(int64_t *)(iVar1 + 0x28) == iStack_48) {
        return;
    }
